    ...
    <header class="bg-white shadow-md">
      <div class="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <nav class="hidden md:flex items-center space-x-6">
          <a routerLink="/" class="text-gray-700 hover:text-primary font-medium">Jobs</a>
        ...
        <div class="flex items-center space-x-4">
          <a routerLink="/login" class="text-primary hover:text-primary-dark font-medium">Login</a>
          <a routerLink="/signup" class="bg-primary text-white px-4 py-2 rounded-md hover:bg-primary-dark font-medium">Sign Up</a>
        </div>
      </div>
    </header>
  `,
